...
function tablaPosicional(config) {
  const { container, params, variables, versions, vt } = config;
  var imgSrcFlechaAbajo = '../../../../imagenes_front/flechas/flecha_2.svg';
  var imgSrcSignoMas = '../../../../imagenes_front/tablas_posicionales/NumeracionSuma.png';
  ...
  function muestraValoresPosicionales(valorPosicional, yStart, diviciones, anchoSeparaciones, imgFlechaAbajo, imgSignoMas) {
    ...
    for (var i = 1, centroSeccion, centroSeparacion, yTexto; i < diviciones + 1; i++) {
      ...
      if (typeof numerosValorPosicional[i - 1] === 'string') {
        ...
        console.log({ centroSeccion, yTexto, yStart, altoFlechaAbajo: imgFlechaAbajo.height, _separacionElementos, altoTextovp: valorPosicional.altoTexto })
      ...
      if (valorPosicional.mostrarSignoMas === 'si') {
        if (i + 1 !== diviciones + 1) {
          var altoImgSignoMas = 20;
          var anchoImgSignoMas = imgSignoMas.width * altoImgSignoMas / imgSignoMas.height
          var xMas = centroSeparacion - (anchoImgSignoMas / 2);
          var yMas = yStart + imgFlechaAbajo.height + _separacionElementos + (valorPosicional.altoTexto / 2) - (altoImgSignoMas / 2)
          ctx.drawImage(imgSignoMas, xMas, yMas, anchoImgSignoMas, altoImgSignoMas)
        }
      }
    }
