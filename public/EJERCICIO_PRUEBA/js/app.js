...
function tablaPosicional(config) {
  const { container, params, variables, versions, vt } = config;
  var imgSrcFlechaAbajo = 'img/tablas_posicionales/flecha_fija.svg';
  var imgSrcSignoMas = 'img/tablas_posicionales/num_sig_mas.svg';
  var srcFuente = 'font/LarkeNeueThin.ttf';
  //× => ALT+158
...
_dibujaTextoResultado,_altoTextoResultado,_resultado} = params;
  ...
  function dibujaContenidoTabla(anchoSeparaciones, altoImagen) {
    ...
    function dibujaImagen(numero, fila, columna, tipoRepeticion) {
      if (tipoRepeticion === 'pelotas') {
        var src = `img/pelotas_repeticiones/Arreglo${numero}.svg`;
  ...
  function cargaRecursos() {
    ...
    var srcTabla = `img/tablas_posicionales/Tabla${columnas}x${pisos}.svg`
    let recursos = [
